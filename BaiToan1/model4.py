...
X4 = labDF[['Prelab1', 'Prelab1-attempts', 'Prelab1-questions',
            ...
            'Inlab2-questions','Inlab2-growths','Prelab3', 'Prelab3-attempts','Prelab3-questions',
            'Prelab3-growths','Inlab3','Inlab3-attempts','Inlab3-questions','Inlab3-growths','Prelab4',
...
print(X_train4_scaled)
print(X_test4_scaled)
...
best_rf_model.fit(X_train4_scaled, y_train4)

# Dự đoán và tính toán độ chính xác
y_pred = best_rf_model.predict(X_test4_scaled)
